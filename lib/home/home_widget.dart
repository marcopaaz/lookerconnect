                      ...
                      children: [
                        ...
                        FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final textGetAllConnectionsResponse =
                                snapshot.data!;
                            return Text(
                              formatNumber(
                                LookerGroup.getAllConnectionsCall
                                    .connections(
                                      textGetAllConnectionsResponse.jsonBody,
                                    )
                                    .toString()
                                    .length,
                        ...
                        children: [
                          ...
                          FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final textGetUserNumberResponse = snapshot.data!;
                              return Text(
                                formatNumber(
                        ...
                        children: [
                          ...
                          FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final textGetLooksNumberResponse = snapshot.data!;
                              return Text(
                                formatNumber(
