        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'userAttributes',
              path: 'userAttributes',
              builder: (context, params) => UserAttributesWidget(),
            ),
            FFRoute(
              name: 'lookModels',
              path: 'lookModels',
